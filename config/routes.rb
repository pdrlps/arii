ARII::Application.routes.draw do
  ...
  get 'use_cases/customerorders', to: 'use_cases#customerorders'
  get 'use_cases/frauddetection', to: 'use_cases#frauddetection'
  get 'use_cases/datawarehousing', to: 'use_cases#datawarehousing'
  get 'use_cases/operationaldatastores', to: 'use_cases#operationaldatastores'
  get 'use_cases/dashboards', to: 'use_cases#dashboards'
